        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {categories.map((category, index) => (
            <motion.div 
              ...
              className="group relative h-[300px] md:h-[450px] overflow-hidden rounded-2xl md:rounded-[2.5rem] border border-rosegold/5 cursor-pointer"
            >
              <img 
                src={category.image} 
                alt={category.title}
              ...
              <div className="absolute inset-0 p-4 md:p-10 flex flex-col justify-end">
                <h3 className="heading-serif text-xl md:text-3xl mb-1 md:mb-3 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">{category.title}</h3>
                ...
                <p className="text-beige/40 text-[8px] md:text-xs font-light tracking-wide opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500 delay-100 line-clamp-2 md:line-clamp-none">
